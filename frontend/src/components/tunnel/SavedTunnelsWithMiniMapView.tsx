...
const SortableWrapper = ({
  ...
  if (isCollapsed) {
    // When collapsed, the whole item is the drag handle for better UX on a small target.
    return (
      <div
        ref={setNodeRef}
        style={style}
  ...
  // When expanded, use a dedicated drag handle to avoid conflicts with clicks.
  return (
...
interface SavedTunnelsWithMiniMapViewProps {
...
export const SavedTunnelsWithMiniMapView: React.FC<
  SavedTunnelsWithMiniMapViewProps
> = ({
  savedTunnels,
  activeTunnels,
  isLoading,
